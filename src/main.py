...
class IntegratedVideoProcessor:
    ...
    def save_image_to_gcs(self, image, gcs_subfolder, filename):
      ...
      try:
         # Set the full path in the GCS bucket, including the subfolder
    ...
    def process_frame(self):
        while True:
            ...
            for track_id, track in tracks.items():
                ...
                car_image_gcs_path = f'Images/Cars/car_{track_id}_{timestamp}.jpg'
                self.save_image_to_gcs(car_image, 'Images/Cars', f'car_{track_id}_{timestamp}.jpg')
                ...
                for license_plate in license_plate_detections.boxes.data.tolist():
                    ...
                    if car_id != -1:
                        ...
                        license_plate_image_gcs_path = f'Images/license plates/license_plate_{car_id}_{timestamp}.jpg'
                        self.save_image_to_gcs(license_plate_image, 'Images/license plates', f'license_plate_{car_id}_{timestamp}.jpg')
    ...
    def process_video(self):
        ...
        if self.road_mask_file and os.path.exists(self.road_mask_file):
